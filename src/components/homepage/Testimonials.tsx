    ...
    <AnimatedSection>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Testimonials Grid with stagger animation - 1 col mobile, 3 cols desktop */}
          <StaggerList className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((testimonial) => (
              <StaggerItem key={testimonial.id}>
                <article className="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 hover:shadow-lg hover:scale-[1.02] transition-all duration-200 ease-out h-full">
                  {/* Quote Icon */}
