 ...
 * Includes stagger fade-in animation (0.15s delay per logo, <1s total).
 */
    ...
    <AnimatedSection>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Partner logos grid with stagger animation - 2 cols on mobile, 4 on desktop */}
          {/* Using 0.15s stagger delay, 4 logos = ~0.6s total animation (under 1s requirement) */}
          <StaggerList
          ...
          >
            {partners.map((partner) => (
              <StaggerItem key={partner.id}>
                <div className="group flex flex-col items-center justify-center p-6 sm:p-8 bg-surface rounded-xl border border-gray-100 hover:border-primary/20 hover:shadow-md transition-all duration-200 ease-out">
                  {/* Placeholder logo - will be replaced with actual logos */}
                  <div className="h-16 w-full sm:h-20 flex items-center justify-center grayscale group-hover:grayscale-0 transition-all duration-200">
